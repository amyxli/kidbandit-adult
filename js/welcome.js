...
welcome.task = {};
welcome.task.blurb = '<b>The Monsters Game</b> ("Making Decisions to Earn Points") is a short psychological study investigating how people make decisions.';
...
welcome.section.start =
    ...
    '<li> Next comes the experiment itself. Please make sure that you have the sound on for this portion. <br></li>' +
...
welcome.section.demographics =
    ...
    '           <!-- DOB -->' +
    '           <label for="dob"><b>Date of Birth (mm/dd/yyyy): &nbsp;</b></label><input id="dob" name="dob" /><br /><br />' +
    '			<!-- Language -->' +
